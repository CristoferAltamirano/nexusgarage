...
import { Package, Wrench, ScanBarcode, AlertCircle, Layers } from "lucide-react";
            ...
            <table className="w-full caption-bottom text-sm">
                <thead className="bg-slate-50">
                    <tr className="border-b border-slate-100">
                        ...
                        {/* 5. PRECIO: Siempre visible, alineado a la derecha */}
                            ...
                            <td className="p-4 md:p-6 align-middle">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col min-w-0">
                                        <span className="font-medium text-slate-700 text-sm truncate max-w-[160px] sm:max-w-none">
                                            {product.name}
                                        </span>
                                        
                                        {/* INFO SOLO MÓVIL: Aquí mostramos lo que ocultamos en las otras columnas */}
